  ...
  return (
    <SafeAreaView style={{
      ...
      <ScrollView style={{ flex: 1, width: '100%' }}>
        ...
        <Text style={{ marginLeft: 20, marginBottom: 8, fontSize: 16 }}>Dados pessoais</Text>
        ...
        <View style={{ alignItems: 'center' }}>
          ...
          <TextInput placeholder="Documento" style={{ backgroundColor: '#fff', height: 48, width: '90%', padding: 8, marginVertical: 16 }} />
          <TextInput placeholder="CRM" style={{ backgroundColor: '#fff', height: 48, width: '90%', padding: 8, marginVertical: 16 }} />
        </View>
